...
import VariableDetail from "./components/AccumulateDetail";
  ...
  return (
    <ProCard headerBordered title={
        <Space size={'middle'}>
          ...
          <span>指标详情</span>
          <Button type='primary' onClick={() => {history.push(`/strategy/accumulate/update?id=${id}`)}} icon={<EditOutlined/>}>编辑</Button>
