...
public class CountDistinct extends AbstractAggFunction {
    ...
    public Object getValue(AccumulateRequest request) {
        ...
        Set<Object> values = redisTemplate.opsForSet().union(keys.get(0), keys);
    ...
    public String function() {
        return AccumulateFunction.COUNT_DISTINCT.name();
    }
}
